...
await copyFile(
  ...
  new URL('dist/garlic-herb-mayonnaise-pork-chops-page-code.txt', root),
);
...
const notices = [
  ...
  '',
  'Geist / Geist Mono: SIL Open Font License 1.1, licenses/geist-OFL.txt.',
  'Reused shadcn-related CSS: MIT, licenses/shadcn-MIT.txt.',
  ...
  'Image origin and rights are separate: IMAGE-SOURCES.txt.',
  '',
];
...
console.log('Exported complete identical HTML-code TXT and supporting notices.');
