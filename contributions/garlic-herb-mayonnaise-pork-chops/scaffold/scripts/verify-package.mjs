...
assert.deepEqual(html, await read('dist/garlic-herb-mayonnaise-pork-chops-page-code.txt'));
...
const webp = await read('dist/images/garlic-herb-mayonnaise-pork-chops.webp');
