...
export function GrillPlanner({
  ...
  return (
    <section className="planner" id="setup" aria-labelledby="planner-title">
      ...
      <p>
        Exactly three burners. Choose the ones you want lit, then place every pepper above one or
        more OFF burners. Nothing is preselected, and this diagram does not control the grill.
      </p>
      ...
      <p>
        Covered-grill ambient beside the peppers:{' '}
