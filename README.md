...
**Twenty-four cuts across five categories** — beef, pork, poultry, seafood and
a vegetarian one — each with
...
images/                     All 24 meal photos, kept in step by `npm run build`
...
| `app/cook-config.ts` | The 24 cuts, ingredient scaling, per-cut recipe assembly |
