...
**Twenty-five cuts across five categories** — beef, pork, poultry, seafood and
...
images/                     All 25 meal photos, kept in step by `npm run build`
...
| `app/cook-config.ts` | The 25 cuts, ingredient scaling, per-cut recipe assembly |
