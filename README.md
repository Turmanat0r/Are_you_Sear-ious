...
**Twenty-six cuts across six categories** — beef, pork, poultry, seafood,
vegetarian and breakfast — each with
...
images/                     All 26 meal photos, kept in step by `npm run build`
...
| `app/cook-config.ts` | The 26 cuts, ingredient scaling, per-cut recipe assembly |
