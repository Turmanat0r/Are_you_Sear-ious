...
All 22 food images used by this app were generated with an AI image model.
...
the steakhouse burgers, the butter-bath lobster tails and the garlic-herb
mayonnaise pork chops on 2026-09-11, all using
...
- All 22 original PNGs and all 22 delivered WebPs were hashed with SHA-256.
...
- Each original was re-encoded in memory with the existing conversion settings.
  All 22 results matched the delivered WebP files byte for byte. Seven supplied
...
12 of the 22 PNGs under `originals/`. Every original delivered since then is
